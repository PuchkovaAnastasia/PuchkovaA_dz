...
<?
$vowels = preg_match_all('/[аеиоуэыяю]/iu', $fio.$info.$str.$a.$b.$c.$d.$e.$f.$g.$h);
    echo $vowels;
?>
<p>Количество слов на моей основной странице:</p>
<?
$words = str_word_count(($fio.$info.$str.$a.$b.$c.$d.$e.$f.$g.$h),0, "АаБбВвГгДдЕеЁёЖжЗзИиЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЪъЫыЬьЭэЮюЯя");
    echo $words;
?>
</div>
</body>
